...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.CategoryApi();
  });
  ...
  describe('CategoryApi', function() {
    ...
    describe('queryCategories', function() {
      it('should call queryCategories successfully', function(done) {
        //uncomment below and update the code to test queryCategories
        //instance.queryCategories(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
