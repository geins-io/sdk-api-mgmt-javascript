...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.OrderApi();
  });
  ...
  describe('OrderApi', function() {
    describe('addOrderComment', function() {
      it('should call addOrderComment successfully', function(done) {
        //uncomment below and update the code to test addOrderComment
        //instance.addOrderComment(function(error) {
    ...
    describe('cancelOrderRow', function() {
      it('should call cancelOrderRow successfully', function(done) {
        //uncomment below and update the code to test cancelOrderRow
        //instance.cancelOrderRow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('countOrders', function() {
      it('should call countOrders successfully', function(done) {
        //uncomment below and update the code to test countOrders
        //instance.countOrders(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOrderId', function() {
      it('should call getOrderId successfully', function(done) {
        //uncomment below and update the code to test getOrderId
        //instance.getOrderId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getOrderPublicId', function() {
      it('should call getOrderPublicId successfully', function(done) {
        //uncomment below and update the code to test getOrderPublicId
        //instance.getOrderPublicId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('setPaymentAsPaid', function() {
      it('should call setPaymentAsPaid successfully', function(done) {
        //uncomment below and update the code to test setPaymentAsPaid
        //instance.setPaymentAsPaid(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
