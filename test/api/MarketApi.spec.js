...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.MarketApi();
  });
  ...
  describe('MarketApi', function() {
    describe('getMarketById', function() {
      it('should call getMarketById successfully', function(done) {
        //uncomment below and update the code to test getMarketById
        //instance.getMarketById(function(error) {
