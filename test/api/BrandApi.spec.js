...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.BrandApi();
  });
  ...
  describe('BrandApi', function() {
    ...
    describe('queryBrands', function() {
      it('should call queryBrands successfully', function(done) {
        //uncomment below and update the code to test queryBrands
        //instance.queryBrands(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
