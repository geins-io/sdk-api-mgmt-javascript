...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.MarketModelsMarket();
  });
  ...
  describe('MarketModelsMarket', function() {
    it('should create an instance of MarketModelsMarket', function() {
      // uncomment below and update the code to test MarketModelsMarket
      //var instance = new GeinsSdkApiMgmtJavascript.MarketModelsMarket();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.MarketModelsMarket);
    });
