...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadDiscountCampaign();
  });
  ...
  describe('ProductModelsReadDiscountCampaign', function() {
    it('should create an instance of ProductModelsReadDiscountCampaign', function() {
      // uncomment below and update the code to test ProductModelsReadDiscountCampaign
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadDiscountCampaign();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.ProductModelsReadDiscountCampaign);
    });
