...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.UserModelsWriteUserProfile();
  });
  ...
  describe('UserModelsWriteUserProfile', function() {
    it('should create an instance of UserModelsWriteUserProfile', function() {
      ...
      //var instance = new GeinsSdkApiMgmtJavascript.UserModelsWriteUserProfile();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.UserModelsWriteUserProfile);
    });
