...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.UserModelsReadUserProfile();
  });
  ...
  describe('UserModelsReadUserProfile', function() {
    it('should create an instance of UserModelsReadUserProfile', function() {
      // uncomment below and update the code to test UserModelsReadUserProfile
      //var instance = new GeinsSdkApiMgmtJavascript.UserModelsReadUserProfile();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.UserModelsReadUserProfile);
    });
    ...
    it('should have the property memberDiscount (base name: "MemberDiscount")', function() {
      // uncomment below and update the code to test the property memberDiscount
      //var instance = new GeinsSdkApiMgmtJavascript.UserModelsReadUserProfile();
      //expect(instance).to.be();
    });
