...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.PageResult();
  });
  ...
  describe('PageResult', function() {
    it('should create an instance of PageResult', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.PageResult();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.PageResult);
    });
