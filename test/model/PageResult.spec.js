...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.PageResult();
  });
  ...
  describe('PageResult', function() {
    it('should create an instance of PageResult', function() {
      ...
      //var instance = new GeinsSdkApiMgmtJavascript.PageResult();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.PageResult);
    });
    ...
    it('should have the property hasMoreRows (base name: "HasMoreRows")', function() {
      // uncomment below and update the code to test the property hasMoreRows
      //var instance = new GeinsSdkApiMgmtJavascript.PageResult();
      //expect(instance).to.be();
    });
