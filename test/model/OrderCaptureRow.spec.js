...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.OrderCaptureRow();
  });
  ...
  describe('OrderCaptureRow', function() {
    it('should create an instance of OrderCaptureRow', function() {
      // uncomment below and update the code to test OrderCaptureRow
      //var instance = new GeinsSdkApiMgmtJavascript.OrderCaptureRow();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.OrderCaptureRow);
    });
