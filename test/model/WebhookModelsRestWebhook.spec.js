...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.WebhookModelsRestWebhook();
  });
  ...
  describe('WebhookModelsRestWebhook', function() {
    it('should create an instance of WebhookModelsRestWebhook', function() {
      // uncomment below and update the code to test WebhookModelsRestWebhook
      //var instance = new GeinsSdkApiMgmtJavascript.WebhookModelsRestWebhook();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.WebhookModelsRestWebhook);
    });
