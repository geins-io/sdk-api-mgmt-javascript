...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.BrandModelsReadBrand();
  });
  ...
  describe('BrandModelsReadBrand', function() {
    it('should create an instance of BrandModelsReadBrand', function() {
      // uncomment below and update the code to test BrandModelsReadBrand
      //var instance = new GeinsSdkApiMgmtJavascript.BrandModelsReadBrand();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.BrandModelsReadBrand);
    });
