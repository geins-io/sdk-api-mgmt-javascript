...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.OrderProcessedCapture();
  });
  ...
  describe('OrderProcessedCapture', function() {
    it('should create an instance of OrderProcessedCapture', function() {
      // uncomment below and update the code to test OrderProcessedCapture
      //var instance = new GeinsSdkApiMgmtJavascript.OrderProcessedCapture();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.OrderProcessedCapture);
    });
