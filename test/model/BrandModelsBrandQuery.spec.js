...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.BrandModelsBrandQuery();
  });
  ...
  describe('BrandModelsBrandQuery', function() {
    it('should create an instance of BrandModelsBrandQuery', function() {
      // uncomment below and update the code to test BrandModelsBrandQuery
      //var instance = new GeinsSdkApiMgmtJavascript.BrandModelsBrandQuery();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.BrandModelsBrandQuery);
    });
