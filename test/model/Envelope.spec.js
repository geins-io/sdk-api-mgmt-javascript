...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.Envelope();
  });
  ...
  describe('Envelope', function() {
    it('should create an instance of Envelope', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.Envelope();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.Envelope);
    });
