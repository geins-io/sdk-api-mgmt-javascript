...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.EnvelopeVariantModelsReadVariant();
  });
  ...
  describe('EnvelopeVariantModelsReadVariant', function() {
    it('should create an instance of EnvelopeVariantModelsReadVariant', function() {
      // uncomment below and update the code to test EnvelopeVariantModelsReadVariant
      //var instance = new GeinsManagementApiSdkJs.EnvelopeVariantModelsReadVariant();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.EnvelopeVariantModelsReadVariant);
    });
