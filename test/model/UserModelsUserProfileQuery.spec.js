...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.UserModelsUserProfileQuery();
  });
  ...
  describe('UserModelsUserProfileQuery', function() {
    it('should create an instance of UserModelsUserProfileQuery', function() {
      // uncomment below and update the code to test UserModelsUserProfileQuery
      //var instance = new GeinsSdkApiMgmtJavascript.UserModelsUserProfileQuery();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.UserModelsUserProfileQuery);
    });
    ...
    it('should have the property includeInactive (base name: "IncludeInactive")', function() {
