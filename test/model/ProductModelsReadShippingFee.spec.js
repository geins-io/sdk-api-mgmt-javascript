...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadShippingFee();
  });
  ...
  describe('ProductModelsReadShippingFee', function() {
    it('should create an instance of ProductModelsReadShippingFee', function() {
      // uncomment below and update the code to test ProductModelsReadShippingFee
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadShippingFee();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.ProductModelsReadShippingFee);
    });
