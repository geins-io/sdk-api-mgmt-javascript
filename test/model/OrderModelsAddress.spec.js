...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.OrderModelsAddress();
  });
  ...
  describe('OrderModelsAddress', function() {
    it('should create an instance of OrderModelsAddress', function() {
      // uncomment below and update the code to test OrderModelsAddress
      //var instance = new GeinsSdkApiMgmtJavascript.OrderModelsAddress();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.OrderModelsAddress);
    });
    ...
    it('should have the property entryCode (base name: "EntryCode")', function() {
      // uncomment below and update the code to test the property entryCode
      //var instance = new GeinsSdkApiMgmtJavascript.OrderModelsAddress();
      //expect(instance).to.be();
    });
