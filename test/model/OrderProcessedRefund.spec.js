...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.OrderProcessedRefund();
  });
  ...
  describe('OrderProcessedRefund', function() {
    it('should create an instance of OrderProcessedRefund', function() {
      // uncomment below and update the code to test OrderProcessedRefund
      //var instance = new GeinsManagementApiSdkJs.OrderProcessedRefund();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.OrderProcessedRefund);
    });
