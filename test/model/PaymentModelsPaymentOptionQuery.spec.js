...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.PaymentModelsPaymentOptionQuery();
  });
  ...
  describe('PaymentModelsPaymentOptionQuery', function() {
    it('should create an instance of PaymentModelsPaymentOptionQuery', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.PaymentModelsPaymentOptionQuery();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.PaymentModelsPaymentOptionQuery);
    });
