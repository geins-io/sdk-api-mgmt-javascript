...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.PaymentModelsPaymentOptionQuery();
  });
  ...
  describe('PaymentModelsPaymentOptionQuery', function() {
    it('should create an instance of PaymentModelsPaymentOptionQuery', function() {
      // uncomment below and update the code to test PaymentModelsPaymentOptionQuery
      //var instance = new GeinsSdkApiMgmtJavascript.PaymentModelsPaymentOptionQuery();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.PaymentModelsPaymentOptionQuery);
    });
