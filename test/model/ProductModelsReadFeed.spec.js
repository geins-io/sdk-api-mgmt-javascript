...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadFeed();
  });
  ...
  describe('ProductModelsReadFeed', function() {
    it('should create an instance of ProductModelsReadFeed', function() {
      // uncomment below and update the code to test ProductModelsReadFeed
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsReadFeed();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.ProductModelsReadFeed);
    });
