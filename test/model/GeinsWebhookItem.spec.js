...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.GeinsWebhookItem();
  });
  ...
  describe('GeinsWebhookItem', function() {
    it('should create an instance of GeinsWebhookItem', function() {
      // uncomment below and update the code to test GeinsWebhookItem
      //var instance = new GeinsSdkApiMgmtJavascript.GeinsWebhookItem();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.GeinsWebhookItem);
    });
