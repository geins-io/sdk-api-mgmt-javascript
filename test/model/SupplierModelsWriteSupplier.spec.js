...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.SupplierModelsWriteSupplier();
  });
  ...
  describe('SupplierModelsWriteSupplier', function() {
    it('should create an instance of SupplierModelsWriteSupplier', function() {
      // uncomment below and update the code to test SupplierModelsWriteSupplier
      //var instance = new GeinsSdkApiMgmtJavascript.SupplierModelsWriteSupplier();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.SupplierModelsWriteSupplier);
    });
