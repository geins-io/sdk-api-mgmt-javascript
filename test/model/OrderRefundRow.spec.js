...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.OrderRefundRow();
  });
  ...
  describe('OrderRefundRow', function() {
    it('should create an instance of OrderRefundRow', function() {
      // uncomment below and update the code to test OrderRefundRow
      //var instance = new GeinsManagementApiSdkJs.OrderRefundRow();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.OrderRefundRow);
    });
