...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.CategoryModelsReadCategory();
  });
  ...
  describe('CategoryModelsReadCategory', function() {
    it('should create an instance of CategoryModelsReadCategory', function() {
      // uncomment below and update the code to test CategoryModelsReadCategory
      //var instance = new GeinsSdkApiMgmtJavascript.CategoryModelsReadCategory();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.CategoryModelsReadCategory);
    });
    ...
    it('should have the property googleCategoryPath (base name: "GoogleCategoryPath")', function() {
      // uncomment below and update the code to test the property googleCategoryPath
      //var instance = new GeinsSdkApiMgmtJavascript.CategoryModelsReadCategory();
      //expect(instance).to.be();
    });
