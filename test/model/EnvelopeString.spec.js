...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.EnvelopeString();
  });
  ...
  describe('EnvelopeString', function() {
    it('should create an instance of EnvelopeString', function() {
      // uncomment below and update the code to test EnvelopeString
      //var instance = new GeinsManagementApiSdkJs.EnvelopeString();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.EnvelopeString);
    });
