...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.EnvelopeProductParameterModelsReadProductParameterPredefinedValue();
  });
  ...
  describe('EnvelopeProductParameterModelsReadProductParameterPredefinedValue', function() {
    it('should create an instance of EnvelopeProductParameterModelsReadProductParameterPredefinedValue', function() {
      ...
      //var instance = new GeinsSdkApiMgmtJavascript.EnvelopeProductParameterModelsReadProductParameterPredefinedValue();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.EnvelopeProductParameterModelsReadProductParameterPredefinedValue);
    });
