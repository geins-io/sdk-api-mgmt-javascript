...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.ProductModelsMonitorSku();
  });
  ...
  describe('ProductModelsMonitorSku', function() {
    it('should create an instance of ProductModelsMonitorSku', function() {
      // uncomment below and update the code to test ProductModelsMonitorSku
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsMonitorSku();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.ProductModelsMonitorSku);
    });
