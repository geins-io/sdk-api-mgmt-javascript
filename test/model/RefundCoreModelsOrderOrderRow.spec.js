...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.RefundCoreModelsOrderOrderRow();
  });
  ...
  describe('RefundCoreModelsOrderOrderRow', function() {
    it('should create an instance of RefundCoreModelsOrderOrderRow', function() {
      // uncomment below and update the code to test RefundCoreModelsOrderOrderRow
      //var instance = new GeinsSdkApiMgmtJavascript.RefundCoreModelsOrderOrderRow();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.RefundCoreModelsOrderOrderRow);
    });
    ...
    it('should have the property suggestedRefundAmount (base name: "SuggestedRefundAmount")', function() {
      // uncomment below and update the code to test the property suggestedRefundAmount
      //var instance = new GeinsSdkApiMgmtJavascript.RefundCoreModelsOrderOrderRow();
      //expect(instance).to.be();
    });

    it('should have the property averageDiscount (base name: "AverageDiscount")', function() {
      // uncomment below and update the code to test the property averageDiscount
      //var instance = new GeinsSdkApiMgmtJavascript.RefundCoreModelsOrderOrderRow();
      //expect(instance).to.be();
    });
