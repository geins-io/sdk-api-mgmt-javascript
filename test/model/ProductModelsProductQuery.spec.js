...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.ProductModelsProductQuery();
  });
  ...
  describe('ProductModelsProductQuery', function() {
    it('should create an instance of ProductModelsProductQuery', function() {
      // uncomment below and update the code to test ProductModelsProductQuery
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsProductQuery();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.ProductModelsProductQuery);
    });
    ...
    it('should have the property articleNumbers (base name: "ArticleNumbers")', function() {
      // uncomment below and update the code to test the property articleNumbers
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsProductQuery();
      //expect(instance).to.be();
    });

    it('should have the property onlySellable (base name: "OnlySellable")', function() {
      // uncomment below and update the code to test the property onlySellable
      //var instance = new GeinsSdkApiMgmtJavascript.ProductModelsProductQuery();
      //expect(instance).to.be();
    });
