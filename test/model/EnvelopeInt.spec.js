...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.EnvelopeInt();
  });
  ...
  describe('EnvelopeInt', function() {
    it('should create an instance of EnvelopeInt', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.EnvelopeInt();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.EnvelopeInt);
    });
