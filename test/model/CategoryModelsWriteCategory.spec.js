...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.CategoryModelsWriteCategory();
  });
  ...
  describe('CategoryModelsWriteCategory', function() {
    it('should create an instance of CategoryModelsWriteCategory', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.CategoryModelsWriteCategory();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.CategoryModelsWriteCategory);
    });
