...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsSdkApiMgmtJavascript.CategoryModelsWriteCategory();
  });
  ...
  describe('CategoryModelsWriteCategory', function() {
    it('should create an instance of CategoryModelsWriteCategory', function() {
      // uncomment below and update the code to test CategoryModelsWriteCategory
      //var instance = new GeinsSdkApiMgmtJavascript.CategoryModelsWriteCategory();
      //expect(instance).to.be.a(GeinsSdkApiMgmtJavascript.CategoryModelsWriteCategory);
    });
