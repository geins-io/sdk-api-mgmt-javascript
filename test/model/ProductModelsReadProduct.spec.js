...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GeinsManagementApiSdkJs.ProductModelsReadProduct();
  });
  ...
  describe('ProductModelsReadProduct', function() {
    it('should create an instance of ProductModelsReadProduct', function() {
      ...
      //var instance = new GeinsManagementApiSdkJs.ProductModelsReadProduct();
      //expect(instance).to.be.a(GeinsManagementApiSdkJs.ProductModelsReadProduct);
    });
