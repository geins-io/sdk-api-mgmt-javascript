...
import OrderModelsRefund from './OrderModelsRefund';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('Refunds')) {
                obj['Refunds'] = ApiClient.convertToType(data['Refunds'], [OrderModelsRefund]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['Refunds']) { // data not null
            ...
            for (const item of data['Refunds']) {
                OrderModelsRefund.validateJsonObject(item);
            };
        }
        // ensure the json data is a string
 ...
 * @member {Array.<module:model/OrderModelsRefund>} Refunds
 */
