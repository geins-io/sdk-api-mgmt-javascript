...
class UserModelsWriteUserProfile {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('HasExternalAuth')) {
                obj['HasExternalAuth'] = ApiClient.convertToType(data['HasExternalAuth'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
UserModelsWriteUserProfile.prototype['UserId'] = undefined;
 ...
 * @member {Boolean} HasExternalAuth
 */
UserModelsWriteUserProfile.prototype['HasExternalAuth'] = undefined;
