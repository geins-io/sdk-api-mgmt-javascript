...
import ProductModelsReadDiscountCampaign from './ProductModelsReadDiscountCampaign';
...
class ProductModelsReadProduct {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('DateFirstAvailable')) {
                obj['DateFirstAvailable'] = ApiClient.convertToType(data['DateFirstAvailable'], 'Date');
            }
            ...
            if (data.hasOwnProperty('DiscountCampaigns')) {
                obj['DiscountCampaigns'] = ApiClient.convertToType(data['DiscountCampaigns'], [ProductModelsReadDiscountCampaign]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['DiscountCampaigns']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['DiscountCampaigns'])) {
                throw new Error("Expected the field `DiscountCampaigns` to be an array in the JSON data but got " + data['DiscountCampaigns']);
            }
            // validate the optional field `DiscountCampaigns` (array)
            for (const item of data['DiscountCampaigns']) {
                ProductModelsReadDiscountCampaign.validateJsonObject(item);
            };
        }
 ...
 * @member {Date} DateFirstAvailable
 */
ProductModelsReadProduct.prototype['DateFirstAvailable'] = undefined;
 ...
 * @member {Array.<module:model/ProductModelsReadDiscountCampaign>} DiscountCampaigns
 */
ProductModelsReadProduct.prototype['DiscountCampaigns'] = undefined;
