...
export default class BrandApi {
    ...
    */
     ...
     * @callback module:api/BrandApi~getBrandByIdCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EnvelopeBrandModelsReadBrand} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/BrandApi~getBrandByIdCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EnvelopeBrandModelsReadBrand}
     */
    ...
    /**
     * Query brands
     * @param {module:model/BrandModelsBrandQuery} query The details of the query.
